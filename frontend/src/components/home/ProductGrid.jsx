        ...
        {filteredProducts.map((product, idx) => (
          ...
          >
            <div className="relative aspect-[4/5] overflow-hidden bg-natural-100 dark:bg-dark-secondary rounded-[40px] shadow-2xl transition-all duration-700 group-hover:-translate-y-4">
              ...
              <div className="absolute bottom-8 left-8 right-8 flex flex-col gap-4 translate-y-20 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                <div className="flex gap-2">
                  <button 
                    onClick={() => addToCart(product)}
                    className="flex-1 py-4 bg-white text-natural-900 text-[9px] font-bold uppercase tracking-widest rounded-2xl hover:bg-natural-50 transition-colors shadow-xl"
                  >
                    Panier
                  </button>
                  <button 
                    onClick={() => buyNow(product)}
                    className="flex-[2] py-4 bg-earth-500 text-white text-[9px] font-bold uppercase tracking-widest rounded-2xl hover:bg-earth-600 transition-colors shadow-xl"
                  >
                    Acheter maintenant
                  </button>
                </div>
